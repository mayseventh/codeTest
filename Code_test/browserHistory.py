...
class BrowserHistory(object):
    ...
    def visit(self, url):
        ...
        # print("Current value : {0}, Tail value : {1}".format(current.value, self.tail.value))
    ...
    def back(self, steps):
        ...
        while(steps > 0 and self.tail.prev != None):
            ...
            steps -= 1
            # print("BACK tail.value : {0}".format(self.tail.value))
        return self.tail.value
    ...
    def forward(self, steps):
        ...
        while(steps > 0 and self.tail.next != None):
            ...
            steps -= 1
            # print("FOWARD tail.value : {0}".format(self.tail.value))
        return self.tail.value
